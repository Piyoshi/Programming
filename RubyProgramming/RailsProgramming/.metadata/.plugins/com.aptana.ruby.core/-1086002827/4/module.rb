class Module < Object
  ...
  ARGF = ARGF
  ARGV = ["/Users/uenosatoshi/Desktop/ProgramingFolder/Github/Programming/RubyProgramming/RailsProgramming/.metadata/.plugins/com.aptana.ruby.core/-1086002827/4"]
  ...
  Data = Data
  Dir = Dir
  ENV = {"SHELL"=>"/bin/bash", "TMPDIR"=>"/var/folders/14/ddl2vtx10536rlyyrs3rtv400000gn/T/", "APP_ICON_396"=>"../Resources/aptana.icns", "__CF_USER_TEXT_ENCODING"=>"0x1F5:1:14", "PATH"=>"/usr/bin:/bin:/usr/sbin:/sbin", "COMMAND_MODE"=>"unix2003", "DISPLAY"=>"/tmp/launch-FL80Bi/org.macosforge.xquartz:0", "USER"=>"uenosatoshi", "com.apple.java.jvmTask"=>"JNI", "HOME"=>"/Users/uenosatoshi", "Apple_Ubiquity_Message"=>"/tmp/launch-avsMOn/Apple_Ubiquity_Message", "LOGNAME"=>"uenosatoshi", "JAVA_STARTED_ON_FIRST_THREAD_396"=>"1", "Apple_PubSub_Socket_Render"=>"/tmp/launch-Ys4YGL/Render", "SSH_AUTH_SOCK"=>"/tmp/launch-lMYudy/Listeners"}
  EOFError = EOFError
  ...
  Numeric = Numeric
  OUTPUT_PATH = "/Users/uenosatoshi/Desktop/ProgramingFolder/Github/Programming/RubyProgramming/RailsProgramming/.metadata/.plugins/com.aptana.ruby.core/-1086002827/4/"
  Object = Object
  ...
  TOPLEVEL_BINDING = #<Binding:0x10205ceb0>
  TRUE = true
  Thread = Thread
